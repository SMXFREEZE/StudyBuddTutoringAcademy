      ...
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <h2 className="section-title mb-3 sm:mb-4 opacity-0 fade-in-element">
            Modern Tutoring, Proven Results
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            description="Every session is tailored to your unique learning style, pace, and academic goals for maximum effectiveness."
            index={0}
          />
          <FeatureCard
            ...
            description="Book sessions that fit your schedule with options for individual, group, and package deals."
            index={1}
          />
          <FeatureCard
            ...
            description="Our tutors create a supportive environment where questions are encouraged and learning happens at your pace."
            index={2}
          />
          <FeatureCard
            ...
            description="Track your progress with regular assessments and see real improvement in your understanding and grades."
            index={3}
          />
          <FeatureCard
            ...
            description="Expert tutoring in Math, Physics, Chemistry, English/French writing, Philosophy, and more academic subjects."
            index={4}
          />
          <FeatureCard
            icon={<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 sm:w-6 sm:h-6"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="m22 21-3-3m0 0a8 8 0 1 0-6-6 8 8 0 0 0 6 6z"></path></svg>}
            title="Affordable Options"
            description="Competitive rates with special discounts for monthly and yearly packages to make quality tutoring accessible."
            index={5}
          />
        </div>
      </div>
