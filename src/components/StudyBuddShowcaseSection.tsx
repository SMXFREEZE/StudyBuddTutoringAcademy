...
const StudyBuddShowcaseSection = () => {
  ...
  return (
    <section ref={sectionRef} className="w-full py-20 bg-gray-100" id="studybudd-showcase">
        ...
        <div className="flex flex-col items-center opacity-0 translate-y-10 transition-all duration-1000">
          <div className="mb-12 text-center">
            <div className="pulse-chip mb-4">
              ...
              <span>Meet StudyBudd</span>
            </div>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-bold mb-4">
              Quality Tutoring Meets <span className="text-[#FC4D0A]">Modern Innovation</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              StudyBudd Academy represents the perfect fusion of traditional academic excellence and 
              innovative teaching methods, designed to seamlessly integrate into students' learning environments.
            </p>
          </div>
          
          <div className="relative w-full max-w-4xl overflow-hidden rounded-3xl shadow-2xl bg-white">
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-8">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-white text-xl font-semibold">Next Generation Learning</h3>
                  <p className="text-white/80">Designed for student success</p>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            <div className="bg-white p-6 rounded-xl shadow-elegant hover:shadow-elegant-hover transition-all duration-300">
              ...
              <h4 className="text-lg font-semibold mb-2">Expert Teaching</h4>
              <p className="text-gray-600">Professional tutors with advanced knowledge provide real-time feedback and personalized guidance.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-elegant hover:shadow-elegant-hover transition-all duration-300">
              ...
              <p className="text-gray-600">Continuously adapts to each student's learning style to improve performance and create personalized study plans.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-elegant hover:shadow-elegant-hover transition-all duration-300">
              ...
              <p className="text-gray-600">Designed for natural scheduling flexibility with multiple time slots available for optimal learning.</p>
            </div>
          </div>
        </div>
      </div>
...
export default StudyBuddShowcaseSection;
